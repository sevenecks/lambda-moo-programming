...
- Removed the bundled HTML edition of the updated LambdaMOO Programmer's Manual in
  favor of the maintained Markdown edition.
...
* Updated README to point to new guide location
